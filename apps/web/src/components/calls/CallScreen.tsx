    ...
    <div className="fixed inset-0 z-[60] flex flex-col items-center justify-center bg-black/95 text-white">
      {status === "incoming" && (
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-xl font-semibold">{callInfo.otherName} is calling...</p>
      ...
      {(status === "connected" || (status === "outgoing" && remoteStream)) && (
        <div className="relative h-full w-full">
          ...
          <video
            ...
            playsInline
            muted
            className="absolute bottom-24 right-4 h-32 w-24 rounded-xl border-2 border-white/50 object-cover sm:h-48 sm:w-36"
          />
